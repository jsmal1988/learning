package courses.concurrencythreads.e_concurrentcollections;
...
/**
* Latch -> a signle thread can wait for othre threads
...
public class C_CyclicBarrier {
	...
	public static void main(String[] args) {
		...
		CyclicBarrier barrier = new CyclicBarrier(5, new Runnable() {
			...
			@Override
			public void run() {
				System.out.println("All Tasks has been finished");
			}
		});
		
		for(int i=0;i<5;++i)
			executorService.execute(new WorkerCyclicBarrier(i+1, barrier));
