package courses.streams.collectionsstreamslamba.d_mapfilter;
...
public class MainReduction {
	...
	public static void main(String[] args) {
		...
		int finalReduction = reduce(Arrays.asList(reduction1, reduction2),0, op);

		System.out.println("ReductionFinal:" + finalReduction);
